...
async function receiveDataFromQueue() {
    ...
    const myMessageHandler = async (messageReceived) => {
        await htmlToPdf.generateHtml(messageReceived.body.htmlTemplate, messageReceived.body.jsonData);
        console.log(`Received message: ${i++} ${messageReceived.body.htmlTemplate} ${messageReceived.body.jsonData.firstName}`);
    };
