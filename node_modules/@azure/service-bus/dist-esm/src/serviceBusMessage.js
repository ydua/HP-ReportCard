 ...
 */
export function fromRheaMessage(rheaMessage, delivery, shouldReorderLockToken) {
    var _a, _b;
    if (!rheaMessage) {
        rheaMessage = {
            body: undefined
...
export class ServiceBusMessageImpl {
    ...
    constructor(msg, delivery, shouldReorderLockToken, receiveMode) {
        const _a = fromRheaMessage(msg, delivery, shouldReorderLockToken), { _rawAmqpMessage } = _a, restOfMessageProps = __rest(_a, ["_rawAmqpMessage"]);
